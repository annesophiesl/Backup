...
replace av10_`x'=mean_`x' if av10_`x'==.
}
bysort interval10 country: gen behold10=1 if _n==1

gen av10_soc_cap = av10_health + av10_edu + av10_welf + av10_pen + av10_unemp
gen av10_nonsoc_cap = av10_all_cap - av10_soc_cap
...
xtset country_num
xtreg av10_soc_cap av10_linc av10_tax_indi av10_tax_corp av10_tax_prop av10_linc2 av10_young_adult av10_young_adult2 av10_school_age av10_school_age2 av10_old av10_old2 av10_turn_over av10_voter av10_income_p90_p50 av10_labour_force_m_work av10_labour_force_m_work2 if behold10==1, robust re
