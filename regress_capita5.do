...
gen av5_soc_cap = av5_health + av5_welf + av5_pen_old + av5_unemp
...
gen av5_soc_cap2=av5_soc_cap*av5_soc_cap
gen av5_pen_cap2=av5_pen_cap*av5_pen_cap
gen av5_edu_cap2=av5_edu_cap*av5_edu_cap
gen av5_health_cap2=av5_health_cap*av5_health_cap
gen av5_welf_cap2=av5_welf_cap*av5_welf_cap
gen av5_nonsoc_cap2=av5_nonsoc_cap*av5_nonsoc_cap
gen av5_unemp_cap2=av5_unemp_cap*av5_unemp_cap



xtset country_num

foreach x in av5_all_cap av5_nonsoc_cap av5_soc_cap av5_pen_cap av5_welf_cap av5_unemp_cap av5_edu_cap av5_health_cap {
xtreg `x' av5_linc av5_linc2 av5_young_adult av5_young_adult2 av5_school_age av5_school_age2 av5_old av5_old2 av5_turn_over av5_voter av5_income_p90_p50 av5_labour_force_m_work av5_labour_force_m_work2 if behold5==1, robust re
outreg2 using "C:\Users\AnneSophie\Documents\Polit\BA\output\reg_spending_cap5.xls", append pvalue ctitle(`x') label sideway
}

xtreg av5_linc av5_gdp_capita_lag av5_lap_cap av5_open av5_lag_pri av5_lag_sec av5_lag_teri av5_young av5_young_adult av5_old av5_nonsoc_cap av5_edu_cap2 av5_edu_cap av5_nonsoc_cap2 av5_soc_cap av5_soc_cap2 if behold5==1, robust re
outreg2 using "C:\Users\AnneSophie\Documents\Polit\BA\output\reg_linc25.xls", replace pvalue ctitle(EQ. 1) label sideway


xtreg av5_linc av5_gdp_capita_lag av5_lap_cap av5_open av5_lag_pri av5_lag_sec av5_lag_teri av5_young av5_young_adult av5_old av5_health_cap av5_health_cap2 av5_pen_cap av5_pen_cap2 av5_welf_cap av5_welf_cap2 av5_unemp_cap av5_unemp_cap2 av5_nonsoc_cap av5_nonsoc_cap2 av5_edu_cap av5_edu_cap2 if behold5==1, robust re
outreg2 using "C:\Users\AnneSophie\Documents\Polit\BA\output\reg_linc25.xls", append pvalue ctitle(EQ. 2) label sideway

xtreg av5_linc av5_gdp_capita_lag av5_lap_cap av5_open av5_young av5_young_adult av5_old av5_nonsoc_cap av5_edu_cap2 av5_edu_cap av5_nonsoc_cap2 av5_soc_cap av5_soc_cap2 if behold5==1, robust re
outreg2 using "C:\Users\AnneSophie\Documents\Polit\BA\output\reg_linc25.xls", replace pvalue ctitle(EQ. 1) label sideway


xtreg av5_linc av5_gdp_capita_lag av5_lap_cap av5_open av5_young av5_young_adult av5_old av5_health_cap av5_health_cap2 av5_pen_cap av5_pen_cap2 av5_welf_cap av5_welf_cap2 av5_unemp_cap av5_unemp_cap2 av5_nonsoc_cap av5_nonsoc_cap2 av5_edu_cap av5_edu_cap2 if behold5==1, robust re
outreg2 using "C:\Users\AnneSophie\Documents\Polit\BA\output\reg_linc25.xls", append pvalue ctitle(EQ. 2) label sideway
...
#delimit;
sem
(av5_linc <- av5_lap_cap av5_lag_pri av5_lag_sec av5_lag_teri av5_gdp_capita_lag av5_open av5_lag_pri av5_lag_sec av5_lag_teri av5_young av5_young_adult av5_old av5_corp av5_soc_cap av5_soc_cap2 av5_nonsoc_cap av5_nonsoc_cap2 av5_edu_cap av5_edu_cap2)
(av5_soc_cap <- av5_linc av5_linc2 av5_young_adult av5_young_adult2 av5_school_age av5_school_age2 av5_old av5_old2 av5_turn_over av5_voter av5_income_p90_p50), nocapslatent;
